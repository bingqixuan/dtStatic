...
const YsThree = (function (DOC, WIN, U) {
    /* 共享参数 ****/
    let  app, camera, renderer, scene, controls, el // 初始化一些变量
    const mouse = new THREE.Vector2() // 用于射线
    const raycaster = new THREE.Raycaster() // 用于射线
...
window.YsThree = YsThree // 给 window对象
