...
Promise.all([
    ...
    const setHypocenter = _params => {
        ...
        panel.innerHTML =
            ...
            '<div class="panel-section-title">发生日期</div>' +
            ...
            '</div>' +
            '<div class="panel-section">' +
            '<div class="panel-section-title">震中地名</div>' +
            '<div class="panel-section-body">' +
            ...
            '<div class="panel-column">' +
            '<div class="panel-section">' +
            '<div class="panel-section-title">震源深度</div>' +
            ...
            '</div>' +
            '<div class="panel-section">' +
            '<div class="panel-section-title">震级</div>' +
