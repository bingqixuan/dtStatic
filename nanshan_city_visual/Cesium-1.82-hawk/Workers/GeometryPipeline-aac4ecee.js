...
define(['exports', './AttributeCompression-d1cd1d9c', './Cartesian2-e9bb1bb3', './Check-5e798bbf', './when-208fe5b0', './Math-56f06cd5', './Transforms-b2c3e401', './ComponentDatatype-b3120730', './EncodedCartesian3-099fd63d', './GeometryAttribute-dddfbf98', './IndexDatatype-4d4b60a0', './IntersectionTests-19697198', './Plane-6fbc10a1'], function(exports, AttributeCompression, Cartesian2, Check, when, _Math, Transforms, ComponentDatatype, EncodedCartesian3, GeometryAttribute, IndexDatatype, IntersectionTests, Plane) {
    'use strict';
    ...
    function computeTriangleAttributes(
        ...
        if (when.defined(extrudeDirections)) {
            ...
            var direction;
            if (!Cartesian2.Cartesian3.equals(d0, Cartesian2.Cartesian3.ZERO) ||
