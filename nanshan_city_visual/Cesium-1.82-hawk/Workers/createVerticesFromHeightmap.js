        ...
        for (var rowIndex = startRow; rowIndex < endRow; ++rowIndex) {
            ...
            for (var colIndex = startCol; colIndex < endCol; ++colIndex) {
                ...
                if (elementsPerHeight === 1) {
                    ...
                    if (isBigEndian) {
                        for (
                            elementOffset = 0; elementOffset < elementsPerHeight;
                            ++elementOffset
                        ) {
                            heightSample =
                        ...
                        for (
                            elementOffset = elementsPerHeight - 1; elementOffset >= 0;
                            --elementOffset
                        ) {
                            heightSample =
                                heightSample * elementMultiplier +
        ...
        var Lerc2Decode = (function() {
            ...
            var Lerc2Helpers = {
                ...
                readHuffmanTree: function(input, data) {
                    ...
                    var decodeLut = [],
                        entry, code, numEntries, jj, currentBit, node;
                    for (i = i0; i < i1; i++) {
                        j = i - (i < size ? 0 : size); //wrap around
                        len = codeTable[j].first;
                        if (len > 0) {
                ...
                readHuffman: function(input, data, OutPixelTypeArray) {
                     ...
                     *  decode
                     ***************************/
                    var node, val, delta, mask = data.pixels.resultMask,
                        valTmp, valTmpQuick, currentBit;
                    var i, j, k, ii;
                    var prevVal = 0;
                    if (bitPos > 0) {
                        srcPtr++;
