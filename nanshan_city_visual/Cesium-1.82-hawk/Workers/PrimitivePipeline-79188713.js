...
define(['exports', './Transforms-b2c3e401', './ComponentDatatype-b3120730', './when-208fe5b0', './Check-5e798bbf', './Cartesian2-e9bb1bb3', './GeometryAttribute-dddfbf98', './GeometryAttributes-b0b294d8', './GeometryPipeline-aac4ecee', './IndexDatatype-4d4b60a0', './WebMercatorProjection-7b54c659'], function(exports, Transforms, ComponentDatatype, when, Check, Cartesian2, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, WebMercatorProjection) {
    'use strict';
    ...
    PrimitivePipeline.unpackCombineGeometryParameters = function(
        ...
        for (var resultIndex = 0; resultIndex < length; resultIndex++) {
            ...
            for (
                var geometryIndex = 0; geometryIndex < geometriesLength; geometryIndex++
            ) {
