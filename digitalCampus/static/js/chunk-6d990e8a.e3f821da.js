    ...
    ["chunk-6d990e8a"], {
        ...
        "23a4": function(t, a, s) {
            ...
            var e = function() {
                    var t = this,
                        ...
                        s = t._self._c || a;
                    return s("div", {
                        staticClass: "office-wapper"
                    }, [0 == t.xiaotaiyang.pageMode ? s("div", {
                        staticClass: "office-left",
                        attrs: {
                            "data-msg": "教学楼左边内容"
                        }
                    }, [s("div", {
                        staticClass: "office-l-top"
                    }, [s("digital-container", {
                        ...
                        attrs: {
                            currentList: t.xiaotaiyang.xtyMock["行政楼"]["校园预警"]["列表"],
                            slidesPerView: 5
                        }
                    })], 1)])], 1), s("div", {
                        staticClass: "office-l-center"
                    }, [s("digital-container", {
                        ...
                        attrs: {
                            slot: "content",
                            number: t.xiaotaiyang.xtyMock["行政楼"]["能源趋势"]["能源消耗"],
                            title: "能源消耗",
                            switchData: [{
                                name: "年"
                            }, {
                        ...
                        attrs: {
                            echartsData: t.xiaotaiyang.xtyMock["行政楼"]["能源趋势"]["图表"],
                            yaxisLeftText: "电量/千瓦时"
                        }
                    })], 1)])], 1)], 1), s("div", {
                        staticClass: "office-l-bottom"
                    }, [s("digital-container", {
                        ...
                        staticClass: "office-lc-main",
                        attrs: {
                            slot: "content"
                        },
                        slot: "content"
                    }, [s("div", {
                        staticClass: "office-lc-top"
                    }, [s("div", [s("span", [t._v("设备总数")]), s("span", {
                        staticClass: "font-pmzd"
                    }, [t._v(t._s(t.xiaotaiyang.xtyMock["行政楼"]["设备状态"]["设备总数"]))])]), s("div", [s("span", [t._v("上一小时能耗")]), s("span", {
                        staticClass: "font-pmzd"
                    }, [t._v(t._s(t.xiaotaiyang.xtyMock["行政楼"]["设备状态"]["上一小时能耗"]) + "kw/h")])])]), s("div", {
                        staticClass: "office-lc-bottom"
                    }, [s("div", [s("span", [t._v("开启设备")]), s("span", {
                        staticClass: "font-pmzd"
                    }, [t._v(t._s(t.xiaotaiyang.xtyMock["行政楼"]["设备状态"]["开启设备"]))])]), s("div", [s("span", [t._v("关闭设备")]), s("span", {
                        staticClass: "font-pmzd"
                    }, [t._v(t._s(t.xiaotaiyang.xtyMock["行政楼"]["设备状态"]["关闭设备"]))])]), s("div", [s("span", [t._v("故障设备")]), s("span", {
                        staticClass: "font-pmzd"
                    }, [t._v(t._s(t.xiaotaiyang.xtyMock["行政楼"]["设备状态"]["故障设备"]))])])])])])], 1)]) : t._e(), 0 == t.xiaotaiyang.pageMode ? s("div", {
                        staticClass: "office-right",
                        attrs: {
                            "data-msg": "教学楼右边内容"
                        }
                    }, [s("div", {
                        staticClass: "office-r-top"
                    }, [s("digital-container", {
                        ...
                        attrs: {
                            turn: t.xiaotaiyang.xtyMock["行政楼"]["设备使用率"]["照明"],
                            title: "照明"
                        }
                    }), s("equipmentCharts", {
                        attrs: {
                            turn: t.xiaotaiyang.xtyMock["行政楼"]["设备使用率"]["空调"],
                            title: "空调"
                        }
                    }), s("equipmentCharts", {
                        attrs: {
                            turn: t.xiaotaiyang.xtyMock["行政楼"]["设备使用率"]["多媒体"],
                            title: "多媒体"
                        }
                    }), s("equipmentCharts", {
                        attrs: {
                            turn: t.xiaotaiyang.xtyMock["行政楼"]["设备使用率"]["监控"],
                            title: "监控"
                        }
                    }), s("equipmentCharts", {
                        attrs: {
                            turn: t.xiaotaiyang.xtyMock["行政楼"]["设备使用率"]["消防"],
                            title: "消防"
                        }
                    })], 1)])], 1)]) : t._e()])
                },
                ...
                _ = f,
                v = (s("45a4"), s("cba8")),
                C = Object(v["a"])(_, e, n, !1, null, "352de79c", null);
            a["default"] = C.exports
        },
        "2be8": function(t, a, s) {},
        "38d9": function(t, a, s) {},
        ...
        "4f43": function(t, a, s) {
            ...
            var e = function() {
                ...
                o = c,
                l = (s("47e1"), s("cba8")),
                d = Object(l["a"])(o, i, r, !1, null, "585930a0", null),
                u = d.exports,
                m = {
                    name: "equipment",
                    components: {
                ...
                p = m,
                f = (s("ca1c"), Object(l["a"])(p, e, n, !1, null, "fee92dd6", null));
            a["a"] = f.exports
        },
        "7c1b": function(t, a, s) {},
        8872: function(t, a, s) {
            ...
            var e = function() {
                ...
                r = i,
                c = (s("c13c"), s("cba8")),
                o = Object(c["a"])(r, e, n, !1, null, "52743ffc", null);
            a["a"] = o.exports
        },
        "99f6": function(t, a, s) {},
        c13c: function(t, a, s) {
        ...
        e123: function(t, a, s) {
            ...
            var e = function() {
                ...
                r = i,
                c = (s("0103"), s("cba8")),
                o = Object(c["a"])(r, e, n, !1, null, "d94750c4", null);
            a["a"] = o.exports
        }
    }
]);